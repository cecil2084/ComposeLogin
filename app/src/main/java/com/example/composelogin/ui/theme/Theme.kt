...
//    val studdyColors = when {
//        darkTheme -> StuddyDarkPalette
//        else -> StuddyLightPalette
//    }

    val studdyColors = StuddyLightPalette

    CompositionLocalProvider(LocalStuddyColors provides studdyColors) {
        MaterialTheme(
